...
<svg style="width:0; height:0; position: absolute; top: -9999px;">
	<symbol id="logo" viewBox="0 0 761.9 189.9">
...
<!--
		...
		<div class="btn-container">
			<a class="btn-std btn-blue" href="<?php echo get_permalink( get_page_by_path( 'contact-us' ) ); ?>">Contact Us</a>
			<a class="btn-std btn-blue btn-mayumi" href="<?php echo get_permalink( get_page_by_path( 'community' ) ); ?>">Community</a>
		</div>
